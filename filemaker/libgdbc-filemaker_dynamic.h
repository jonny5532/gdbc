#ifndef __LIBGDBC_FILEMAKER_H
#define __LIBGDBC_FILEMAKER_H
...
typedef char* (*setDate_fn_t)(graal_isolatethread_t*, int, int, long long int);

typedef long long int (*getDate_fn_t)(graal_isolatethread_t*, int, int);
